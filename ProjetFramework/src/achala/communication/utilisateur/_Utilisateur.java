...
public interface _Utilisateur extends Remote {
	...
	/**
	 * Retourne une chaine unique permettant de referencer un utilisateur dans
	 * le serveur
	 * 
	 ...
	 * 
	 * @param server
	 *            _Server : serveur ou l'utilisateur souhaite se connecter
	 * @throws RemoteException
	 *             leve une exception en cas d'echec de communication
	 ...
	 * 
	 * @param share
	 *            _Shared : zone d'echange
	 * @param rObject
	 *            _RemotableObject : objet a envoyer
	 * @throws RemoteException
	 *             leve une exception en cas d'echec de communication
	 * @throws CommunicationException
	 ...
	 * 
	 * @param u
	 *            _Utilisateur : utilisateur a comparer
	 * @return boolean : true si les utilisateurs sont identique, false dans le
	 *         cas contraire
	 * @throws RemoteException
	 *             leve une exception en cas d'echec de communication
	 */
